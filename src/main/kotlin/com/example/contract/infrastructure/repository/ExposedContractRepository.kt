...
class ExposedContractRepository : ContractRepository {
    ...
    override fun findAll(
        ...
        transaction {
            ...
            query
                .orderBy(ContractsTable.createdAt to SortOrder.DESC, ContractsTable.id to SortOrder.ASC)
                .limit(limit)
    ...
    override fun update(contract: Contract): Contract =
        transaction {
    ...
    override fun deleteById(id: ContractId): Unit =
        transaction {
            ContractsTable.deleteWhere { ContractsTable.id eq id.value }
        }

    private fun ResultRow.toContract(): Contract =
        Contract(
